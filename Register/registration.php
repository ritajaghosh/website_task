      ...
      <div class="col-md-6 form-container">
        ...
        <form id="registrationform">
          ...
          <div class=" form-field mb-3">
            ...
            <input type="date" class="form-control" placeholder="**********" id="dob" required>
          </div>
          <div class="mb-3 form-field ">
            <label class="form-label">What is your childhood name?</label>
            <input type="name" class="form-control" placeholder="**********" id="cname" required>
          </div>
          <div class="mb-3 form-field ">
            <label class="form-label">What is your school name?</label>
            <input type="nanme" class="form-control" placeholder="**********" id="schname" required>
          </div>
          <div class="mb-3 form-field ">
            <label class="form-label">Email</label>
            <input type="email" class="form-controlname/" placeholder="Email address..." id="email" required>
          </div>
          <div class="mb-3 form-field ">
          ...
          <div class="mb-3 form-field ">
            ...
            <input type="password" class="form-control" placeholder="**********" id="rpassword" required>
          </div>
          <div class="mb-3 form-field ">
            <label class="form-label"></label>
            <input type="password" class="form-control" placeholder="**********" id="conpassword" required>
          </div>
